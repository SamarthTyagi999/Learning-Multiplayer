...
public class PlayerController : MonoBehaviourPunCallbacks,IPunObservable
{
    ...
    public void Initialize(Player player)
    {
        ...
        //if this isn't our local player,disable physics as thats
    ...
    private void Update()
    {
        ...
        if (photonView.IsMine)
        {
            ...
            if (Input.GetKeyDown(KeyCode.Space))
                TryJump();
            //track the amount of time we're waring the hat
    ...
    void Move()
    {
        //gets horizontal movement i.e a or d or left and right arrow
